      ...
      <SettingsCtx.Provider value={settings}>
          <div className="relative bg-void text-text-primary font-body overflow-x-hidden">
              ...
              <div className="relative z-10 pointer-events-none">
                  ...
                  >
                      <div
                          className="text-center pointer-events-auto bg-void/40 backdrop-blur-md p-10 rounded-3xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                      ...
                      <div
                          className={`absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 bg-void/40 backdrop-blur-md px-4 py-3 rounded-2xl border border-white/5 transition-opacity duration-500 ${scrolled ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
                      >
