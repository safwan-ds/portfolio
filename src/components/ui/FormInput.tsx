...
const INPUT_CLASSES =
  'w-full px-4 py-3 rounded-xl bg-carbon/50 border border-slate/30 font-body text-sm text-text-primary placeholder:text-text-secondary/40 focus:outline-none focus:border-accent/50 transition-all'
