              ...
              <GlassCard key={lang.key}>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-4">
                  ...
                  <p className="font-display text-sm sm:text-base font-semibold text-text-primary flex items-center gap-1.5 sm:gap-2 sm:w-32 shrink-0">
                    <FlagIcon lang={lang.key as 'arabic' | 'english' | 'turkish'} className="w-5 h-3.5 sm:w-6 sm:h-4 rounded-sm shrink-0" />
                  ...
                  <div className="flex items-center gap-2 sm:gap-4 flex-1">
                    ...
                    {/* Level label */}
                    <p className="font-mono text-[10px] sm:text-xs text-text-secondary w-28 text-right shrink-0 truncate" title={t(`languages.levels.${lang.levelKey}`)}>
