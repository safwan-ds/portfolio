...
import {HiOutlineEnvelope, HiPaperAirplane} from 'react-icons/hi2'
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <NeonButton type="submit" disabled={status === 'sending'} solid>
                        {status === 'sending' ? (
                            <>
                                <span
                                    className="w-4 h-4 border-2 border-neon-blue/30 border-t-neon-blue rounded-full animate-spin"/>
                                {t('contact.sending')}
                            </>
                        ) : (
                            <>
              ...
              <div className="space-y-5">
                  <GlassCard>
                      ...
                      <a
                          ...
                          className="font-mono text-sm text-neon-blue hover:text-neon-cyan transition-colors"
                      >
                          {profile.email}
                      </a>
                  </GlassCard>
